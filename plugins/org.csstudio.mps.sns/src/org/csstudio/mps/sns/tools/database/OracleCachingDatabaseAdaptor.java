...
public class OracleCachingDatabaseAdaptor extends CachingDatabaseAdaptor
{
  ...
  public OracleCachingDatabaseAdaptor() throws org.csstudio.mps.sns.tools.database.DatabaseException
  {
    ...
    catch (SQLException exception)
    {
      ...
      .log(Level.SEVERE, "Error creating the data source object.", exception);
      throw new DatabaseException("Exception creating the data source.", this,
                                  exception);
    }
  }
                                  ...
                                  String password) throws org.csstudio.mps.sns.tools.database.DatabaseException
  {
    try
    {
      ...
      if (cache.getUser() == null || cache.getUser() != user)
      {
        cache.setUser(user);
    ...
    catch (java.sql.SQLException ex)
    {
      try
      {
        ...
        //Connect worked. Use failover instead.
        usingFailOver = true;
        connected = true;
        return connection;
      }
      catch (java.sql.SQLException exc)
      {
        ...
        throw new DatabaseException("Exception connecting to the database.  Check User ID and/or Password", this, exc);
      }
    }
  }
  ...
  public void close() throws org.csstudio.mps.sns.tools.database.DatabaseException
  {
    ...
    {
      Logger.getLogger("global")
      .log(Level.SEVERE, "Error closing database connections.", exception);
      throw new DatabaseException("Exception closing database connections.",
                                  this, exception);
    }
  }
  ...
  public Connection getConnection() throws DatabaseException
  {
    ...
    catch (SQLException ex)
    {
      ...
      {
        Logger.getLogger("global")
        .log(Level.SEVERE, "Error connecting to the database.", exc);
        throw new DatabaseException("Exception connecting to the database.",
                                    this, exc);
      }
    }
  }
  ...
  public Blob newBlob(final Connection connection)
  {
    ...
    {
      throw new DatabaseException("Exception instantiating a Blob.", this,
                                  exception);
    }
  }
                        ...
                        Object array) throws DatabaseException
  {
    ...
    {
      Logger.getLogger("global")
      .log(Level.SEVERE, "Error instantiating an SQL array of type: " + type,
                                     exception);
      throw new DatabaseException("Exception generating an SQL array.", this,
                                  exception);
    }
  }
  ...
  /**
	 ...
	 */
  private ArrayDescriptor getArrayDescriptor(final String type,
                                             final Connection connection) throws SQLException
  {
    ...
    else
    {
      ArrayDescriptor descriptor =
        ArrayDescriptor.createDescriptor(type, connection);
  ...
  {
    if (isUsingFailOver())
      return getFailOverDatabase().getOracleDataSource();
    else
      return dataSource;
  }
   ...
   * @throws org.csstudio.mps.sns.tools.database.DatabaseException Thrown on database error.
   */
  public String getServerName() throws org.csstudio.mps.sns.tools.database.DatabaseException
  {
   ...
   * @throws org.csstudio.mps.sns.tools.database.DatabaseException Thrown on database error.
   */
  public String getDatabaseName() throws org.csstudio.mps.sns.tools.database.DatabaseException
  {
   ...
   * @throws org.csstudio.mps.sns.tools.database.DatabaseException Thrown on SQL error.
   */
  public String getURL() throws org.csstudio.mps.sns.tools.database.DatabaseException
  {
    try
    {
    ...
    {
      Logger.getLogger("global")
      .log(Level.SEVERE, "Error getting URL for database.", exception);
      throw new DatabaseException("Exception getting database URL.", this,
                                  exception);
    }
  }
  ...
  public String getConnectionCacheName()
  {
    ...
    {
      Logger.getLogger("global")
      .log(Level.SEVERE, "Error getting the connection cache name.",
                                     exception);
      throw new DatabaseException("Exception getting cache name.", this,
                                  exception);
    }
  }
  ...
  public void setConnectionCacheName(String connectionCacheName)
  {
    ...
    {
      Logger.getLogger("global")
      .log(Level.SEVERE, "Error setting the connection cache name.",
                                     exception);
      throw new DatabaseException("Exception setting cache name.", this,
                                  exception);
    }
  }
  ...
  {
    if (isUsingFailOver())
      return getFailOverDatabase().getDescription();
    else
      return description;
  }
  ...
  {
    if (isUsingFailOver())
      getFailOverDatabase().setDescription(description);
    else
  ...
  public String[] getUserRoles() throws org.csstudio.mps.sns.tools.database.DatabaseException
  {
    ...
    {
      Logger.getLogger("global")
      .log(Level.SEVERE, "Error getting roles from the RDB.", ex);
      throw new DatabaseException("Exception getting roles.", this, ex);
    }
  }

@Override
public List<String> fetchNontrivialSchemas(Connection connection) {
