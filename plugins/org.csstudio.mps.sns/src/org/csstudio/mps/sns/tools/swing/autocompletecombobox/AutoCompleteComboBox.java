...
public class AutoCompleteComboBox extends JComboBox
{
        ...
        while(editorTextLength > 0)
        {
          ...
          for(int i=0;i<itemCount;i++)
          {
            ...
            if(currentItem == null)
              ...
              currentString = currentItem.toString().toUpperCase();
            if(currentString.startsWith(editorText.toUpperCase()))
            {
              ...
              return;
            }//if(getItemAt(i).toString().toUpperCase().startsWith(text))
          }//for(int i=0;i<itemCount;i++)
  ...
  public Object getSelectedItem()
  {
    ...
    if(isEditable())
    {
      ...
      if(editorItem != null && ! selectedItem.equals(editorItem))
    ...
    for(int i=0;i<itemCount;i++)
    {
      ...
      if(currentItem == null)
        ...
        stringValue = currentItem.toString();
      if(selectedItem.equals(stringValue))
        return getItemAt(i);
    }
    return selectedObject;
  }
