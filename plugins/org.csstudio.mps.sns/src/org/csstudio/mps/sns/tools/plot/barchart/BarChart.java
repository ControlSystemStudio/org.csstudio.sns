package org.csstudio.mps.sns.tools.plot.barchart;
...
import org.csstudio.mps.sns.tools.plot.*;
import org.csstudio.mps.sns.tools.swing.*;
...
public class BarChart {
   ...
   */
  public void setBarColumns(Vector clmns) {

    GP.removeAllCurveData();
    barColumns.clear();
    int nCv = 0;
    java.util.Iterator itr = clmns.iterator();
    while (itr.hasNext()) {
      BarColumn bc = (BarColumn) itr.next();
      barColumns.add(bc);
      nCv += bc.size();
