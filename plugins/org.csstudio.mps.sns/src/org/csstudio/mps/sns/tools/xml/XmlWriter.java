...
public class XmlWriter {
    ...
    static public void writeToUrl(Document newDocument, URL url)
          throws MalformedURLException, IOException {  
        String filePath = url.getFile();
        writeToPath(newDocument, filePath);
    }
    
        
    /** write the XML document to the URL spec */
    static public void writeToUrlSpec(Document newDocument, String urlSpec)
          throws MalformedURLException, IOException {  
    ...
    static public void writeToPath(Document newDocument, String filePath) 
          throws IOException {
