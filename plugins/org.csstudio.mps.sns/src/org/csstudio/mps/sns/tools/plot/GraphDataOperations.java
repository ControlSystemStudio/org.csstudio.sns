...
public class  GraphDataOperations{
    ...
    static public Double findIntersectionX(Vector gdV, double xMin, double xMax, double eps){
	return findIntersection(gdV,xMin,xMax,-Double.MAX_VALUE,Double.MAX_VALUE,eps)[0];
    }

    static public Double findIntersectionY(Vector gdV, double xMin, double xMax, double eps){
	return findIntersection(gdV,xMin,xMax,-Double.MAX_VALUE,Double.MAX_VALUE,eps)[1];
    }

    static public Double[] findIntersection(Vector gdV, double xMin, double xMax, double eps){
	return findIntersection(gdV,xMin,xMax,-Double.MAX_VALUE,Double.MAX_VALUE,eps);
    }

    static public Double findIntersectionX(Vector gdV, double xMin, double xMax, 
                                           double yMin, double yMax, double eps){
        return findIntersection(gdV,xMin,xMax,yMin,yMax,eps)[0];
    }

    static public Double findIntersectionY(Vector gdV, double xMin, double xMax, 
                                           double yMin, double yMax, double eps){
	return findIntersection(gdV,xMin,xMax,yMin,yMax,eps)[1]; 
    }

    static public Double[] findIntersection(Vector gdV, double xMin, double xMax, 
                                            double yMin, double yMax, double eps){
        Double intersX       = null;
        Double intersY       = null;
	...
	int nPoints = 0;
		...
		for(int j = 0; j < gdV.size(); j++){
		    if(i != j){
			BasicGraphData gd1 = (BasicGraphData) gdV.get(i);
			BasicGraphData gd2 = (BasicGraphData) gdV.get(j);
			synchronized(gd1){
			    synchronized(gd2){
     ...
     */
    static public Object[] getGraphDataAndPointIndexInside(Vector gdV,
						double xMin, double xMax, 
						double yMin, double yMax){
	Object[] objArr = new Object[2];
        objArr[0] = null;
        objArr[1] = null;
	Vector rezV = getDataInsideRectangle(gdV,xMin,xMax,yMin,yMax);
        if(rezV.size() == 1){
	    BasicGraphData gd = (BasicGraphData) rezV.get(0);
	    objArr[0] = gd;
