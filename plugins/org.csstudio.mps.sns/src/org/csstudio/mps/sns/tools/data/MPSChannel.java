...
//  /**
//   * Holds the fast protect latch value, if any.
//   */
//  private BigDecimal fastProtectLatch;
  /**
   * Holds the SW jumper value. Default is "N".
   */
  private String swJumper;
//  /**
//   * Holds the fast protect auto reset value, if any.
//   */
//  private BigDecimal fastProtectAutoReset;
  /**
...
//  /**
//   * Flag used to determine if the channel is in the database or not. 
...
//  private boolean inDatabase = true;
   ...
   */
  public final static String NUMBER_COLUMN_NAME = "CHANNEL_NBR";
  /**
   * Holds the name of the RDB column for the locked indicator property.
   */
  public final static String LOCKED_INDICATOR_COLUMN_NAME = "LOCKED_IND";
  /**
   * Holds the name of the RDB column for the SWJumper property.
   */
  public final static String SW_JUMPER_COLUMN_NAME = "SW_JUMP";
  /**
   * Holds the name of the RDB column for the limit property.
   */
  public final static String LIMIT_COLUMN_NAME = "LIMIT";
  /**
   * Holds the name of the RDB column for the rate property.
   */
  public final static String RATE_COLUMN_NAME = "RATE";
  /**
   * Holds the name of the RDB column for the device property.
   */
  public final static String DEVICE_COLUMN_NAME = "MPS_DVC_ID";
  /**
   * Holds the name of the RDB column for the channel in use property.
   */
  public final static String IN_USE_INDICATOR_COLUMN_NAME = "CHAN_IN_USE_IND";
  /**
  ...
  {
    if(inUseIndicator == null)
      return "N";
    return inUseIndicator;
  }

//  /**
//   * Sets the value for the fast protect auto reset property. This property 
//   * reflects the value of the FAST_PROTECT_AUTO_RESET database field.
//   * 
//   * @param fastProtectAutoReset The new value for the fast protect auto reset property.
//   */
//  public void setFastProtectAutoReset(BigDecimal fastProtectAutoReset)
//  {
//    this.fastProtectAutoReset = fastProtectAutoReset;
//  }
//
//  /**
//   * Gets the value for the fast protect auto reset property. This property 
//   * reflects the value of the FAST_PROTECT_AUTO_RESET database field.
//   * 
//   * @return The current value for the fast protect auto reset property.
//   */
//  public BigDecimal getFastProtectAutoReset()
//  {
//    return fastProtectAutoReset;
//  }
//
//  /**
//   * Sets the value for the fast protect latch property. This property  reflects 
//   * the value of the FAST_PROTECT_LATCH database field.
//   * 
//   * @param fastProtectLatch The new value for the fast protect latch property.
//   */
//  public void setFastProtectLatch(BigDecimal fastProtectLatch)
//  {
//    this.fastProtectLatch = fastProtectLatch;
//  }
//
//  /**
//   * Gets the value for the fast protect latch property. This property  reflects 
//   * the value of the FAST_PROTECT_LATCH database field.
//   * 
//   * @return The current value for the fast protect latch property.
//   */
//  public BigDecimal getFastProtectLatch()
//  {
//    return fastProtectLatch;
//  }
...
//   * <CODE>true</CODE> by default.
//   * 
//   * @param inDatabase Set as <CODE>true</CODE> if the channel is in the database, <CODE>false</CODE> if not.
//   */
...
//   * <CODE>true</CODE> by default.
//   * 
//   * @return <CODE>true</CODE> if the channel is in the database, <CODE>false</CODE> if not.
//   */
...
//    clone.setFastProtectAutoReset(getFastProtectAutoReset());
//    clone.setFastProtectLatch(getFastProtectLatch());
    clone.setLimit(getLimit());
    clone.setLockedIndicator(getLockedIndicator());
    clone.setRate(getRate());
    Device cloneDevice = getDevice();
    if(cloneDevice != null)
      cloneDevice = (Device)cloneDevice.clone();
    ...
    for(int i=0;i<fieldNames.length;i++) 
      clone.setBinaryValue(fieldNames[i], getBinaryValue(fieldNames[i]));
    return clone;
  }
  ...
  {
    if(rdbFieldName.equals(NUMBER_COLUMN_NAME))
      return new Integer(getNumber());
    if(rdbFieldName.equals(LOCKED_INDICATOR_COLUMN_NAME))
      return getLockedIndicator();
    if(rdbFieldName.equals(SW_JUMPER_COLUMN_NAME))
      return getSWJumper();
    if(rdbFieldName.equals(LIMIT_COLUMN_NAME))
      return new Integer(getLimit());
    if(rdbFieldName.equals(RATE_COLUMN_NAME))
    ...
    if(rdbFieldName.equals(IN_USE_INDICATOR_COLUMN_NAME))
      return getInUseIndicator();
  ...
  {
    if(rdbFieldName.equals(NUMBER_COLUMN_NAME))
      setNumber(((Number)value).intValue());
    else if(rdbFieldName.equals(LOCKED_INDICATOR_COLUMN_NAME))
      setLockedIndicator((String)value);
    else if(rdbFieldName.equals(SW_JUMPER_COLUMN_NAME))
      setSWJumper((String)value);
    else if(rdbFieldName.equals(LIMIT_COLUMN_NAME))
      setLimit(((Number)value).intValue());
    else if(rdbFieldName.equals(RATE_COLUMN_NAME))
      setRate(((Number)value).intValue());
    else if(rdbFieldName.equals(DEVICE_COLUMN_NAME))
    {
      Device device = getDevice();
      if(device == null)
        setDevice(new Device((String)value));
      else
        device.setID((String)value);
    }
    else if(rdbFieldName.equals(IN_USE_INDICATOR_COLUMN_NAME))
      setInUseIndicator((String)value);
    else if(value instanceof byte[])
      setBinaryValue(rdbFieldName, new BigInteger((byte[])value));
  }
   ...
   * 
   * @param date The <CODE>Date</CODE> of the <CODE>MPSChannelAudit</CODE> to return. Returns <CODE>null</CODE> if no matching <CODE>MPSChannelAudit</CODE> is found.
   * @return
   */
  public MPSChannelAudit getAudit(Date date)
  {
    int auditCount = getAuditCount();
    for(int i=0;i<auditCount;i++) 
    {
      MPSChannelAudit audit = getAuditAt(i);
      if(audit.getDate().equals(date))
        return audit;
    }
    return null;
  }
  ...
  {
    int auditCount = getAuditCount();
    java.sql.Timestamp latestDate = null;
    ...
    for(int i=0;i<auditCount;i++) 
    {
      ...
      {
        java.sql.Timestamp newDate = audit.getDate();
  ...
  {
    audits.add(audit);
    if(audit.getChannel() != this)
      audit.setChannel(this);
  }
}