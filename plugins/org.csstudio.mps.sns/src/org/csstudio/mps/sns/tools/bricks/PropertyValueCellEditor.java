...
public class PropertyValueCellEditor extends AbstractCellEditor implements TableCellEditor, TableCellRenderer {
	...
	/** Constructor */
	public PropertyValueCellEditor( final JTable table, final PropertyValueEditorManager propertyEditorManager, final PropertyTableModel tableModel ) {
	...
	public Object getCellEditorValue() {
		return _currentEditor.getEditorValue();
	}
