 ...
 * arbitrary separator.  It contains several convenience methods for appending
 * a wide variety of objects and primitives.  Once you are done appending items
...
public class StringJoiner {
     private Joiner _joiner;         // the object that does the joining
     private String _separator;     // the separator between consecutive items
     private StringBuffer _buffer;   // the buffer holding the joined string
     ...
     public StringJoiner( final String separator ) {
         ...
         _buffer = new StringBuffer();   // create an empty string buffer
