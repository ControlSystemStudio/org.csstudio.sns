	...
	*/
    protected void setup( final URL[] urls ) {		
		...
		try {
			...
			//TODO see if this can be stopped when cancel button is pressed.
			//System.out.println("FrameAppaication InvocationTargetException catch" );
			//System.out.println("      - May want to try to fix this." );
			//throw new RuntimeException( exception );
		}
