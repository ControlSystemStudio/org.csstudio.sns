...
import org.csstudio.mps.sns.tools.apputils.files.*;
...
abstract public class AbstractApplicationAdaptor implements ApplicationListener {
     ...
     */
    abstract XalAbstractDocument generateEmptyDocument( final String type );
     ...
     * error to the application's console or whether it should simply go to 
     * the terminal from which the application was launched.  The default 
     * is to return true thus indicating that the console should be used.
    ...
    /**
	 * Subclasses may override this method to provide custom handling upon completion of the 
	 * application having launched.  The default implementation does nothing.
     */
    public void applicationFinishedLaunching() {}
    
	
    /**
	 * Implement ApplicationListener.  Subclasses may implement this method to handle a document
	 * closed event at the application level.  The default implementation does nothing.
     */
    public void documentClosed( final XalAbstractDocument document ) {}
    
    
    /**
	 * Implement ApplicationListener.  Subclasses may implement this method to handle a document created 
	 * event at the application level.  The default implementation does nothing.
     */
    public void documentCreated( final XalAbstractDocument document ) {}
    
    
    /**
	 * Implement ApplicationListener.  Subclasses may implement this method to handle an 
	 * "application will quit" event at the application level.  The default implementation does nothing.
     */
    ...
    /**
	 * Subclasses should override this method if the resources folder path 
     * is in a location other than the default one.  The default file path 
     * is a subfolder called <code>resources</code> located within the same 
     * folder where the runtime subclass of ApplicationAdaptor resides.
     * Java package path notation is used.
     * For example "org.csstudio.mps.sns.apps.Myapp.resources".
    ...
    /**
	 * Get the path to the specified named resource which resides in the the resource
	 * folder path as specified by the getResourcesPath() method.  For example if 
	 * the resources path is org.csstudio.mps.sns.apps.Myapp.resources and we wish to get the
	 * resource path to the menudef.properties file, the resourceName to specify 
	 * would simply be "menudef" and the method would return 
	 * "org.csstudio.mps.sns.apps.Myapp.resources.menudef".
    ...
    /**
	 * Subclasses should override this method if the menudefinition properties 
     * file is in a location other than the default one.  The default file path is 
     * a properties file called <code>"menudef.properties"</code> located in the 
     * resources folder.  Java package path notation is used.  The file's suffix is
     * excluded from the path.
     * For example "org.csstudio.mps.sns.apps.Myapp.resources.menudef".
    ...
    /**
	 * Subclasses should override this method if the application information properties 
     * (displayed in the "About" box) file is in a location other than the default one.  
     * The default file path is a properties file called <code>"About.properties"</code> 
     * located in the resources folder.  Java package path notation is used.  The file's 
     * suffix is excluded from the path.
     * For example "org.csstudio.mps.sns.apps.Myapp.resources.About".
    ...
    /**
	 * Subclasses should override this method if the application Help file 
     * is in a location other than the default one.  
     * The default file is an HTML file called <code>"Help.html"</code> 
